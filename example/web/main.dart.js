...
(function dartProgram() {
  ...
  P = {
    ...
    Future_wait: function(futures, $T) {
      var _error_get, _error_set, _stackTrace_get, _stackTrace_set, handleError, future, pos, e, st, t2, t3, _i, t4, exception, stackTrace, _box_0 = {}, cleanUp = null,
        eagerError = false,
      ...
      try {
        ...
        _box_0.values = P.List_List$filled(t4, null, false, $T._eval$1("0?"));
      } catch (exception) {
  ...
  T = {
    _injectJsSource: function(src) {
      var loading = H.setRuntimeTypeInfo([], type$.JSArray_Future_void);
      C.JSArray_methods.forEach$1(src, new T._injectJsSource_closure(T._htmlHead(), loading));
      return P.Future_wait(loading, type$.void);
    },
    _htmlHead: function() {
      ...
      if (head != null)
        ...
        throw H.wrapException(P.StateError$("Could not fetch html head element!"));
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return P._asyncAwait(P.Future_Future$delayed(C.Duration_5000000, type$.dynamic), $async$main);
            case 2:
              // returning from await.
              $async$goto = 3;
              return P._asyncAwait(T._injectJsSource(H.setRuntimeTypeInfo(["alert('Hello World!');"], type$.JSArray_String)), $async$main);
            case 3:
              // returning from await.
              // implicit return
  ...
  P.Stream_first_closure0.prototype = {
    call$1: function(value) {
      P._cancelAndValue(this.subscription, this.future, this.$this.$ti._precomputed1._as(value));
    },
    $signature: function() {
      return this.$this.$ti._eval$1("~(1)");
    }
  ...
  W.ScriptElement.prototype = {
    set$async: function(receiver, value) {
  ...
  T._injectJsSource_closure.prototype = {
    call$1: function(script) {
      ...
      C.ScriptElement_methods.set$async(scriptTag, false);
      scriptTag.innerText = script;
      J.get$children$x(this.head).add$1(0, scriptTag);
      t1 = new W._ElementEventStreamImpl(scriptTag, "load", false, type$._ElementEventStreamImpl_Event);
      C.JSArray_methods.add$1(this.loading, t1.get$first(t1));
    },
    $signature: 23
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.FormElement, W.ScriptElement, W.SelectElement]);
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "~(~())", "Null(@)", "Null()", "String(int)", "~(Event)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "@(Object)", "@(StackTrace)", "Object()", "StackTrace()", "~(Object,StackTrace)", "Null(Object,StackTrace)", "_Future<@>(@)", "bool(Node)", "Element(Node)", "~(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"]},"MappedIterator":{"Iterator":["2"]},"WhereIterable":{"Iterable":["1"]},"WhereIterator":{"Iterator":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"ListMixin":["1"],"List":["1"],"Iterable":["1"]},"int":{"num":[]},"List":{"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Element":{"Node":[],"EventTarget":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"_ChildNodeListLazy":{"ListMixin":["Node"],"List":["Node"],"Iterable":["Node"],"ListMixin.E":"Node"},"NodeList":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"ScriptElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"FilteredElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
